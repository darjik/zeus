...
@Entity
@Table(name = "order_task_documents")
public class OrderTaskDocument {
    ...
    // Constructors
    public OrderTaskDocument() {
    }

    public OrderTaskDocument(OrderTask orderTask, String documentName, String originalFilename,
